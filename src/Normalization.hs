...
decompose_types_assumptions (Pi n k y) env = do
    (insert n k (decompose_types_assumptions n (decompose_types_assumptions k (decompose_types_assumptions y env))))
...
decompose_types_assumptions' (Abs k y) (Pi n type' y') env names = do
    let (x, names') = do
        decompose_types_assumptions' y y' (decompose_types_assumptions n (decompose_types_assumptions type' (decompose_types_assumptions y' env))) names
